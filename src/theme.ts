...
export const THEMES: Record<ThemeKey, ThemeTokens> = {
  ...
  stationery: {
    ...
    panel:
      "relative overflow-hidden rounded-3xl border border-[#d9cec1]/65 bg-[#fdf9f2]/92 shadow-[0_12px_28px_rgba(112,99,88,0.12)] backdrop-blur",
    ...
    stage:
      "h-[280px] md:h-[360px] rounded-2xl border border-[#d9cec1]/60 bg-[linear-gradient(160deg,#fdf8f1,#f1e8de)] flex items-center justify-center relative overflow-hidden shadow-[inset_0_0_0_1px_rgba(255,255,255,0.78)]",
    card: "rounded-2xl border border-[#d9cec1]/60 bg-white/92 p-4 md:p-5 shadow-[0_10px_24px_rgba(112,99,88,0.12)]",
    mono: "",
    toggleWrap: "rounded-xl border border-[#d8ccc0]/70 bg-white/92 p-1 shadow-[0_3px_12px_rgba(112,99,88,0.1)]",
