  ...
  return (
    <div className="relative h-56 w-56 md:h-72 md:w-72 [perspective:920px]">
      <div className={`absolute inset-0 left-1/2 top-1/2 h-[174px] w-[122px] -translate-x-1/2 -translate-y-1/2 [transform-style:preserve-3d] md:h-[212px] md:w-[146px] ${shaking ? "animate-tubeSpin3d" : ""}`}>
        <div className="absolute -top-5 left-1/2 h-7 w-[136px] -translate-x-1/2 rounded-full border border-cyan-300/70 bg-zinc-900 shadow-[0_0_12px_rgba(34,211,238,0.24)]" />
        <div className="absolute -top-3 left-1/2 h-3 w-[108px] -translate-x-1/2 rounded-full bg-cyan-300/25" />
        ...
        <div className="absolute -bottom-5 left-1/2 h-7 w-[136px] -translate-x-1/2 rounded-full border border-fuchsia-300/60 bg-zinc-900 shadow-[0_0_12px_rgba(217,70,239,0.18)]" />
      </div>

      <div className="absolute bottom-5 left-1/2 h-3 w-[150px] -translate-x-1/2 rounded-full bg-cyan-400/20 blur-[2px]" />
    </div>
  );
}
